...
class OrganizationServiceImplTest {
    ...
    @Test
    void create_shouldSeedNineDefaultCostSharingRules_whenNoExistingRules() {
        ...
        verify(costSharingRuleRepository, times(9)).save(captor.capture());
