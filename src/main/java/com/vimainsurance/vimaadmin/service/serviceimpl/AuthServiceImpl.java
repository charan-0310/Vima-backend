...
public class AuthServiceImpl implements IAuthService{
    ...
    public ResponseEntity<ResponseDto<LoginResponseDto>> login(LoginRequestDto requestDto) {
        ...
        try {
            ...
            String token = jwtUtil.generateToken(requestDto.getUsername(), adminUser.getRole());
            String refreshToken = jwtUtil.generateToken(requestDto.getUsername(), adminUser.getRole());
